...
uwsgi-gevent:
	ROOT_URLCONF=django_sync_or_async.urls.sync uwsgi --module django_sync_or_async.wsgi:application --processes 1 --gevent 100 --lazy-apps --gevent-monkey-patch --master --die-on-term --http 0.0.0.0:8002 --stats :3032 --stats-http
